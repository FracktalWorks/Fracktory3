...
UM.Dialog
{
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","Fracktory is developed by Frackal works based on the open source project Cura developed by Ultimaker B.V. in cooperation with the community.\nFracktory uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
