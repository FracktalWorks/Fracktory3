...
Packages
{
    ...
    bannerText: catalog.i18nc("@text", "Streamline your workflow and customize your Fracktory experience with plugins contributed by our amazing community of users.")
