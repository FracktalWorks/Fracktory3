...
Packages
{
    ...
    bannerText: catalog.i18nc("@text", "Manage your Fracktory plugins and material profiles here. Make sure to keep your plugins up to date and backup your setup regularly.")
