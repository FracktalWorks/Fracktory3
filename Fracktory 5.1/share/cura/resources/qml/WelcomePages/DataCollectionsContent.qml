...
//
// This component contains the content for the "Help us to improve Fracktory" page of the welcome on-boarding process.
//
Item
{
    ...
    UM.Label
    {
        ...
        text: catalog.i18nc("@label", "Help us to improve Fracktory")
    ...
    Item
    {
        ...
        Column
        {
            ...
            UM.Label
            {
                ...
                anchors.horizontalCenter: parent.horizontalCenter
                horizontalAlignment: Text.AlignHCenter
                text: catalog.i18nc("@text", "Fracktory collects anonymous data to improve print quality and user experience, including:")
            ...
            UM.Label
            {
                ...
                text:
                {
                    var t = catalog.i18nc("@text", "Data collected by Fracktory will not contain any personal information.")
