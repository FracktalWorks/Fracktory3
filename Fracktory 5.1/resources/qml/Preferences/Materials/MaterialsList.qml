...
Item
{
    ...
    Cura.FracktalMaterialsModel
    {
        id: fracktalMaterialsModel
        extruderPosition: Cura.ExtruderManager.activeExtruderIndex
    }
    ...
    function expandActiveMaterial(search_root_id)
    {
        ...
        for (var material_idx = 0; material_idx < fracktalMaterialsModel.rowCount(); material_idx++)
        {
            var material = fracktalMaterialsModel.getItem(material_idx)
    ...
    Column
    {
        ...
        {
            id: genericSection
            sectionName: "Fracktal Works"
            elementsModel: fracktalMaterialsModel
            hasMaterialTypes: false
        }
