...
UM.Dialog
{
    ...
    //: About dialog title
    title: catalog.i18nc("@title:window","About Fracktory")

    minimumWidth: 650 * screenScaleFactor
    ...
    {
        id: logo
        width: (base.minimumWidth * 0.5) | 0
        height: (width * (1/9.41)) | 0
        ...
        anchors.top: parent.top
        anchors.topMargin: version.height | 0
        anchors.horizontalCenter: parent.horizontalCenter
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","Fracktory is based on Cura, developed by Ultimaker B.V. and the community.\nFracktory and Cura proudly use the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
