...
Column
{
    ...
    Item
    {
        id: variantInfoRow
        height: UM.Theme.getSize("sidebar_setup").height
        visible: (Cura.MachineManager.isCurrentSetupSupported && Cura.MachineManager.hasVariants && machineExtruderCount.properties.value > 1) && !sidebar.hideSettings
        ...
        Label {
            ...
            text: "<i>Select <b>Support Nozzles</b> for dissolvable support. Otherwise, select <b>Model Nozzles</b></i>"
            font: UM.Theme.getFont("default")
            color: UM.Theme.getColor("text")
            verticalAlignment: Text.AlignTop
            width: Math.floor(parent.width - UM.Theme.getSize("default_margin").width)
        }
    }

    // Dual calibration tutorial row
    Item
    {
        id: dualCalibrationMeshRow
        ...
        Item
        {
            id: dualCalibrationMeshLink
            height: UM.Theme.getSize("sidebar_setup").height

            UM.RecolorImage {
                id: dualCalibrationMeshInfoImage
            ...
            Label {
                id: dualCalibrationMeshLabel
                wrapMode: Text.WordWrap
                text: "<a href='%1'><b>Dual Nozzle calibration tutorial</b></a>"
                font: UM.Theme.getFont("default")
                color: UM.Theme.getColor("text")
                linkColor: UM.Theme.getColor("text_link")
                verticalAlignment: Text.AlignTop
                anchors.left: dualCalibrationMeshInfoImage.right
                anchors.leftMargin: UM.Theme.getSize("default_margin").width
                // width: Math.floor(parent.width - UM.Theme.getSize("default_margin").width)
                ...
                MouseArea {
                    ...
                    onClicked: {
                        ...
                        var url = "https://fracktal.in/how-to-calibrate-your-dual-nozzle-3d-printer/"
                        Qt.openUrlExternally(url);
                    }
                    onEntered: {
                        base.showTooltip(
                            dualCalibrationMeshRow,
                            Qt.point(-UM.Theme.getSize("sidebar_margin").width, 0),
                            "Tutorial to calibrate the XY offsets for dual nozzle machines."
                        );
                    }
    ...
    Item
    {
        ...
        Item
        {
            ...
            Label {
                ...
                text: "<b>" + catalog.i18nc("@label", "Check compatibility") + "</b>"
                font: UM.Theme.getFont("default")
                color: UM.Theme.getColor("text")
                // linkColor: UM.Theme.getColor("text_link")
                verticalAlignment: Text.AlignTop
