    ...
    ScrollView
    {
        ...
        Column
        {
            ...
            GridLayout
            {
                ...
                // {
                //     id: sliceEngineLabel
                //     text: catalog.i18nc("@label","Slice Engine:")
                //     anchors.verticalCenter: sliceEngineComboBox.verticalCenter
                // }

                // ComboBox
                // {
                //     id: sliceEngineComboBox
                //     model: ListModel
                //     {
                //         id: sliceEngineList

                //         Component.onCompleted: {
                //             append({ text: "Default", code: "CE_36" })
                //             append({ text: "Experimental", code: "CE_43" })
                //         }
                //     }

                //     currentIndex:
                //     {
                //         var code = UM.Preferences.getValue("general/slice_engine");
                //         for(var i = 0; i < sliceEngineList.count; ++i)
                //         {
                //             if(model.get(i).code == code)
                //             {
                //                 return i
                ...
                //         }
                //     }
                //     onActivated: UM.Preferences.setValue("general/slice_engine", model.get(index).code)
                ...
                //         for(var i = 0; i < sliceEngineList.count; ++i)
                //         {
                //             sliceEngineList.setProperty(i, "text", catalog.i18n(sliceEngineList.get(i).text));
                //         }
            ...
            UM.TooltipArea
            {
                ...
                text: catalog.i18nc("@info:tooltip", "Generate preview image when slicing")

                CheckBox
                {
                    id: generatePreviewCheckbox
                    checked: boolCheck(UM.Preferences.getValue("general/generate_preview"))
                    onClicked: UM.Preferences.setValue("general/generate_preview", checked)

                    text: catalog.i18nc("@option:check", "Save preview along with gcode");
                }
            }
