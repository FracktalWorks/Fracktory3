...
class CuraEngineBackend(QObject, Backend):
    ...
    def __init__(self) -> None:
        ...
        executable_name = "CuraEngine" + self._getSliceEnginePostfix()
        ...
        # self._application.getPreferences().addPreference("general/slice_engine", "CE_36")
    ...
    def _createSocket(self, protocol_file: str = None) -> None:
        if not protocol_file:
            ...
            if not plugin_path:
                ...
                return
            protocol_file = os.path.abspath(os.path.join(plugin_path, "Cura{}.proto".format(self._getSliceEnginePostfix())))
    ...
    def _getSliceEnginePostfix(self) -> str:
        # postfix = CuraApplication.getInstance().getPreferences().getValue("general/slice_engine")
        # if postfix is None or "_" not in postfix:
        #     return "_36"
        # return postfix[2:]
        return "_43"